...
from .modules import AdaptiveRotatedConv2d, RountingFunction,rotate_conv_kernel
...
class LSKblock(nn.Module):
    def __init__(self, dim):
        super().__init__()
        self.conv0 = AdaptiveRotatedConv2d(
            in_channels=dim,
            out_channels=dim,
            kernel_size=5,
            padding=2,
            ...
            kernel_number=4,
            rotate_func=rotate_conv_kernel
        )

        # self.conv0 = nn.Conv2d(dim, dim, 5, padding=2, groups=dim)
        # self.conv_spatial = nn.Conv2d(dim, dim, 7, stride=1, padding=9, groups=dim, dilation=3)
        self.conv_spatial = AdaptiveRotatedConv2d(
            in_channels=dim,
            out_channels=dim,
            kernel_size=7,
            stride=1,
...
class ARCLSKNet(BaseModule):
    ...
    def init_weights(self):
        ...
        if self.init_cfg is None:
            ...
            super(ARCLSKNet, self).init_weights()
