...
class RotatedFhmConvFCBBoxHead(RotatedBBoxHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(RotatedFhmConvFCBBoxHead, self).__init__(
    ...
    def loss(self,
        ...
        if self.flag:
            ...
            if len(hallucinated_embedding) > 0:
                hallucinated_cls_score = self.fc_cls(hallucinated_embedding) if self.with_cls else None
...
@ROTATED_HEADS.register_module()
class RotatedFhmShared2FCBBoxHead(RotatedFhmConvFCBBoxHead):

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(RotatedFhmShared2FCBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=2,
            num_cls_convs=0,
            num_cls_fcs=0,
            ...
            **kwargs)
@ROTATED_HEADS.register_module()
class RotatedFhmShared4Conv1FCBBoxHead(RotatedFhmConvFCBBoxHead):
    """KFIoU RoI head."""

    def __init__(self, fc_out_channels=1024, *args, **kwargs):
        super(RotatedFhmShared4Conv1FCBBoxHead, self).__init__(
            num_shared_convs=4,
            num_shared_fcs=1,
            num_cls_convs=0,
            num_cls_fcs=0,
